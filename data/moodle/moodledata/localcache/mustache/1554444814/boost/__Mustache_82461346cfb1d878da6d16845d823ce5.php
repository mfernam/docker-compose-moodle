...
class __Mustache_82461346cfb1d878da6d16845d823ce5 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionFed1c907fa8d06878d15efc03e1e389f($context, $indent, $value);
        $buffer .= $indent . '</nav>
';
...
';
    ...
    private function section309765c9aa092e600a023c9a9f3b6db2(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionFed1c907fa8d06878d15efc03e1e389f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->section309765c9aa092e600a023c9a9f3b6db2($context, $indent, $value);
