...
class __Mustache_577fdabdf86e44293d421bcb03cf6c77 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template-inline')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'block2584e18ad95606137cb5e0fb404b4009'),
            ));
...
';
    ...
    public function block2584e18ad95606137cb5e0fb404b4009($context)
    {
        $indent = $buffer = '';
