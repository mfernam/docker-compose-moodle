...
class __Mustache_13a935d4991b40159d2abb2e37b36043 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'block5dc8a129039c078b0ece811304b07d2e'),
            ));
...
';
    ...
    public function block5dc8a129039c078b0ece811304b07d2e($context)
    {
        $indent = $buffer = '';
        // 'element.frozen' inverted section
        $value = $context->findDot('element.frozen');
